...
namespace Charity
{
    public partial class Widowers_Data : Form
    {
        MySqlConnection connection;
        MySqlCommand cmd;
        MySqlDataReader dr;

        public Widowers_Data()
        {
        ...
        private void Widowers_Data_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "CALL ShowWidowers_Data();";
            cmd.Connection = connection;
